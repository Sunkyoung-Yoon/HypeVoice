...
- 메인 화면
    ...
    - 보이스 카테고리 검색 화면
    - 보이스 좋아요 기능
    - 보이스 좋아요를 누르면 보이스 좋아요 리스트에 추가된 장면
    - 다른 사람의 보이스 들어가서 보는 장면
- 내 보이스
    - 내 보이스에 등록 된 작업물 클릭해서 상세화면 보는 장면
    - 내 보이스 작업물 등록 장면
- 피드백 게시판
...
- 스튜디오
    ...
    - 기존 방에 들어가서 녹음(자신것만, 모두) 둘 중에 하나 선택해서 녹음해서 다운 받는 장면
- 마이페이지
    - 마이페이지에서 프로필 이미지와 닉네임 수정하는 장면

        ![마이페이지_수정](/uploads/28d5072a5a202dd5b8bfd872bec9dd3d/마이페이지_수정.mp4)
    - 탈퇴하는 장면
    
        ![회원_탈퇴](/uploads/4e590ea4eb7f8f669fd351e0ef1e62c8/회원_탈퇴.mp4)
