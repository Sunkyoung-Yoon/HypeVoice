...
function OpenviduMain() {
  ...
  const downloadFiles = async (fileUrl: string) => {
    try {
      ...
      const filename = getFileNameFromUrl(url) + ".mp3";
  ...
  return (
    ...
    >
      <h1
        style={{ fontFamily: "fantasy", color: "#5b5ff4", fontSize: "120px" }}
      >
        HYPE VOICE
      </h1>
      <>
        ...
        {/* 세션이 있을 때만 OpenviduSession이 나오고 아니면 OpenviduForm */}
        {session && (
          <div
          ...
          >
            ...
            >
              ...
              >
                <ExitToAppIcon fontSize="medium" sx={{ color: "red" }} />
                <p style={{ fontSize: "small" }}>방 나가기</p>
              </button>
              <button
                onClick={() => shareScreen()}
                style={{ borderRadius: "50px", backgroundColor: "white" }}
              >
                <ScreenShareIcon fontSize="medium" sx={{ color: "#5b5ff4" }} />
                <p style={{ fontSize: "small" }}>화면 공유</p>
              </button>
              {!isRecording && (
                <button
                  ...
                  style={{ borderRadius: "50px", backgroundColor: "white" }}
                >
                  <MicIcon fontSize="medium" sx={{ color: "red" }} />
                  <p style={{ fontSize: "small" }}>음성 녹음</p>
                </button>
              )}
              {isRecording && (
                <button
                  ...
                  style={{ borderRadius: "50px", backgroundColor: "white" }}
                >
                  <StopCircleIcon fontSize="large" sx={{ color: "red" }} />
                </button>
              )}
              <button
                onClick={() => handleRecModalOpen()}
                style={{ borderRadius: "50px", backgroundColor: "white" }}
              >
        ...
        {session && (
          <div>
            {messages.map((message, index) => (
              <div key={index} style={{ color: "#5b5ff4" }}>
